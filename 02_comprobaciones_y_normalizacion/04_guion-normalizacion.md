...
- Cliente -> datos propios del cliente.

- Café -> características del producto.

- Zona -> ubicación del cliente.

Estas tablas almacenan información que no depende de ninguna venta.


2º Crear la tabla principal de evento llamada Ventas que recoge las operaciones comerciales e incluye los registros de cuándo y cómo se realizo la venta y quién la hizo.

3º Relacionar Ventas con Café mediante una tabla Pivot, porque una venta puede incluir varios cafés y un café puede aparecer en muchas ventas.
...
- Aísla la información por temática:
Datos de clientes, productos, zonas y ventas están separados y limpios.
- Facilita el análisis:
Podemos calcular KPIs  como ticket medio, top clientes, cafés más vendidos, etc.
- Cumple 3FN:
Cada tabla contiene atributos que dependen únicamente de su clave primaria.
- Permite escalabilidad y trazabilidad:
Si mañana añades nuevos cafés, zonas o valoraciones, no rompes nada.
